...
Original file is located at
    https://colab.research.google.com/drive/1GtW08arJGFJGS-vkGtE6XP-MQx5_LFVu
"""
...
class GridWorld(Env):
    def __init__(self, number_of_robots, number_of_interestpoints, dim, observation_size):
        ...
        for i in range(number_of_interestpoints):
            ...
            print('Interest Point ID = {}: Starting Position = [{}, {}]'.format(
                i, position[0], position[1]))
    ...
    def flatten_multidimensional_index(self):
        ...
        for interestpoint in self.interestpoints:
            ...
            index += (self.dim * self.dim) ** (
                        interestpoint.name + self.number_of_robots) * hash_IP_position_visited
